@echo off
echo ========================================
echo Building Android APK with Fresh Bundle
echo ========================================
echo.
...
REM Step 1: Generate fresh JavaScript bundle
echo Step 1: Generating fresh JavaScript bundle...
echo ========================================
...
echo Step 6: Building Release APK with fresh bundle...
echo ========================================
    ...
    if exist "android\app\build\outputs\apk\release\app-release.apk" (
        ...
        if %ERRORLEVEL% EQU 0 (
            ...
            if %ERRORLEVEL% EQU 0 (
                ...
                echo Bundle: Fresh JavaScript bundle included
                echo Target SDK: 34
                echo Min SDK: 23
                echo ========================================
            ) else (
...
echo Bundle: Fresh JavaScript bundle generated
echo ========================================
pause